...
//        $this->textdomain = isset($args['textdomain']) ? $args['textdomain'] : '';
    ...
    public function field_select( $option ){
        ...
        <select  <?php if($multiple) echo 'multiple'; ?> name="<?php echo $field_name; ?>" id="<?php echo $css_id; ?>">
            ...
            foreach( $args as $key => $name ):
                ...
                ?>
                <option <?php echo $selected; ?> value="<?php echo esc_attr($key); ?>"><?php echo esc_html($name); ?></option>
            <?php
            endforeach;
            ?>
        </select>
    ...
    public function field_select2( $option ){
        ...
        ob_start();
        ?>
        <select <?php echo esc_html($attributes_html); ?> class="select2" <?php if($multiple) echo 'multiple'; ?>  name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($css_id); ?>">
            <?php
            foreach( $args as $key => $name ):
            ...
            <div class="field-input">
                ...
                if(!empty($args))
                    foreach( $args as $key => $value ):
                        ...
                        ?>
                        <label for='<?php echo $for;?>'><input name='<?php echo esc_attr($field_name); ?>[]' type='checkbox' id='<?php echo esc_attr($for); ?>' value='<?php echo esc_attr($key);?>'  <?php echo esc_attr($checked);?>><span><?php echo esc_html($value);?></span></label>
    ...
    public function field_radio( $option ){
        ...
        if(!empty($args))
            foreach( $args as $key => $value ):
                ...
                ?>
                <label for="<?php echo $for;?>"><input name="<?php echo esc_attr($field_name); ?>" type="radio" id="<?php echo esc_attr($for); ?>" value="<?php echo esc_attr($key);?>"  <?php echo esc_attr($checked);?>><span><?php echo esc_html($value);?></span></label>

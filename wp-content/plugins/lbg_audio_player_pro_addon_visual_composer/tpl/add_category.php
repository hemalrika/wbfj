    ...
    <form method="POST" enctype="multipart/form-data" id="form-add-playlist-record">
		<table class="wp-list-table widefat fixed pages" cellspacing="0">
		  <tr>
		    ...
		    <td align="left" valign="middle" width="77%"><a href="?page=LBG_CATEGORIES" style="padding-left:25%;">Back to Manage Categories</a></td>
		  </tr>
		  <tr>
		    <td width="25%" align="right" valign="middle" class="row-title">Name*</td>
		    <td width="77%" align="left" valign="top"><input name="categ" type="text" id="categ" size="80" value="<?php echo $_POST['categ']?>" /></td>
		  </tr>
		  <tr>

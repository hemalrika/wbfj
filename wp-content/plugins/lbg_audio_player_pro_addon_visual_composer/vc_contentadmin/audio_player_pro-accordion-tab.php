...
class WPBakeryShortCode_audio_player_pro_playlist_item extends WPBakeryShortCode_VC_Tab {
	...
	public function contentAdmin( $atts, $content = null ) {
		...
		for ( $i = 0; $i < count( $width ); $i ++ ) {
			$output .= '<div class="group wpb_sortable playlist_item_class">';
			$output .= '<h3><span class="tab-label" style="padding-left:15px;"><%= params.title %> </span></h3>     <div data-element_type="vc_playlist_item" class="vc_playlist_item">';

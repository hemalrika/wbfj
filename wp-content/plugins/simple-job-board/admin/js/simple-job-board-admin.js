        ...
        $('#settings_addFeature').on("click", function () {
            ...
            if (fieldName != '' && job_feature_value != '') {
                ...
                if (fieldIcon != undefined && fieldIcon != '') {
                    ...
                    <input type="text" id="jobfeature_' + fieldName + '" class="sjb-job-feature-icon iconpicker-element iconpicker-input" name="jobfeature_' + fieldName + '[icon]" placeholder="' + fieldIcon + '" value="' + fieldIcon + '" /><span class="input-group-addon"><i class="fa ' + fieldIcon + '"></i></span>\n\
        ...
        $('#addFeature').click(function () {
            ...
            if (fieldName != '' && fieldVal != '') {
                if (fieldIcon != undefined && fieldIcon != '') {
                    ...
                    $('#job_feature_icon').val("fa-briefcase"); //Reset Icon value.
                    $('.sjb_add_icon_fields .input-group-addon i').removeClass();
                    $('.sjb_add_icon_fields .input-group-addon i').addClass("fa fa-briefcase");
                }
                else {

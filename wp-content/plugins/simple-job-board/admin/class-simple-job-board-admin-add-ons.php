...
class Simple_Job_Board_Add_Ons {
    ...
    public function __construct() {
        ...
        $this->api_url = 'https://market.presstigers.com/wc-api/v3/products?filter[limit]=-1';
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 product">
                                        <article>
                                            ...
                                            <div class="price add-to-cart">
                                                ...
                                                <a href="<?php echo esc_url( $home_url . "/cart/?add-to-cart=" . esc_attr( $item->id ) ); ?>" class="button button-primary cart-btn" target="_blank"><?php echo esc_html__('Buy Now', 'simple-job-board'); ?></a>
                                            </div>
                                        </article>
                                    </div>
                                    <?php

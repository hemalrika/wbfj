 ...
 *
 * Override this template by copying it to yourtheme/simple_job_board/v1/single-jobpost/job-meta/company-name.php
 * 
 * @author      PressTigers
...
================================================== -->
<div class="col-md-5">
    <div class="job-info <?php echo esc_attr( $class ); ?>">
        <h4>
            <?php

...
echo '<div class="no-job-listing">'.'<img src="' . esc_attr(apply_filters('sjb_no_jobs_found_img_url', plugin_dir_url(dirname(dirname(dirname(__FILE__)))) . 'public/images/not-found.png')) . '" alt="' . esc_html__('No jobs found', 'simple-job-board') . '" id="sjb-not-found-v2"/>'.'<p class="no-job-listing-text">' . esc_html__('No jobs found', 'simple-job-board') . '</p>';

...
?>
<div class="<?php echo esc_attr( $container_classes ); ?> bf-section-container bf-metabox bf-clearfix" <?php  echo $section_css_attr; ?> <?php  echo $section_attr; ?>>
    <div class="<?php echo esc_attr( $section_classes ); ?> bf-clearfix" data-id="<?php echo esc_attr( $options['id'] ); ?>">
        ...
        <div class="<?php echo esc_attr( $heading_classes ); ?> bf-clearfix">
            <h3><label for="<?php echo esc_attr( $options['input_name'] ); ?>"><?php echo $options['name']; ?></label></h3>
        </div>
